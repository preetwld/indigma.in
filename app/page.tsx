    ...
    <div className="min-h-screen text-slate-200 overflow-x-hidden relative bg-white">
      ...
      <section className="mt-16 min-h-[calc(100vh-4rem)] flex items-center justify-center relative z-10">
        <div className="relative z-10 text-center w-full">
          ...
          <div className="bg-gradient-to-br from-slate-900/80 to-slate-900/80 backdrop-blur-sm p-6 rounded-[3rem] border border-slate-600/30 shadow-2xl shadow-black/50 mx-4">
            <div className="bg-gradient-to-br from-blue-50/95 to-blue-100/95 backdrop-blur-2xl px-6 py-6 md:px-12 md:py-10 rounded-[2.25rem] border border-blue-200/50 shadow-2xl shadow-blue-500/20 text-slate-800 flex flex-col justify-center">
              <div className="bg-gradient-to-br from-blue-50/80 to-white/80 px-6 py-6 md:px-10 md:py-8 rounded-[1.75rem] border border-blue-100/50">

                <h1 className="text-5xl md:text-7xl font-black mb-4 tracking-tight bg-gradient-to-r from-slate-700 to-blue-800 bg-clip-text text-transparent">
                  INDIGMA
                </h1>
